...
const EMPLOYEE_PROFILES = {
  ...
  newHire: {
    ...
    description: 'New hire, still adjusting to workload',
    health: {
      restingHeartRate: { mean: 65, stdDev: 4 },
      heartRateVariability: { mean: 48, stdDev: 6 },
      sleepHours: { mean: 7.2, stdDev: 0.5 },
      sleepQualityScore: { mean: 72, stdDev: 8 },
      deepSleepHours: { mean: 1.4, stdDev: 0.2 },
      remSleepHours: { mean: 1.5, stdDev: 0.2 },
      steps: { mean: 7500, stdDev: 1800 },
      exerciseMinutes: { mean: 35, stdDev: 12 },
    },
    work: {
      hoursWorked: { mean: 8.2, stdDev: 0.7 },
      overtimeHours: { mean: 0.3, stdDev: 0.3 },
      tasksCompleted: { mean: 5, stdDev: 1.5 },
      tasksAssigned: { mean: 5, stdDev: 1 },
      meetingsAttended: { mean: 4, stdDev: 1 },
      emailsSent: { mean: 12, stdDev: 4 },
    },
    expectedZone: 'green',
  },
  ...
  remoteSenior: {
    ...
    description: 'Remote senior engineer, solid performer with occasional late nights',
    health: {
      restingHeartRate: { mean: 62, stdDev: 4 },
      heartRateVariability: { mean: 50, stdDev: 6 },
      sleepHours: { mean: 7.0, stdDev: 0.6 },
      sleepQualityScore: { mean: 75, stdDev: 8 },
      deepSleepHours: { mean: 1.4, stdDev: 0.25 },
      remSleepHours: { mean: 1.6, stdDev: 0.25 },
      steps: { mean: 5500, stdDev: 1500 },
      exerciseMinutes: { mean: 30, stdDev: 15 },
    },
    work: {
      hoursWorked: { mean: 8.0, stdDev: 0.8 },
      overtimeHours: { mean: 0.3, stdDev: 0.4 },
      tasksCompleted: { mean: 7, stdDev: 2 },
      tasksAssigned: { mean: 6, stdDev: 1.5 },
      meetingsAttended: { mean: 4, stdDev: 1.5 },
      emailsSent: { mean: 20, stdDev: 8 },
    },
    expectedZone: 'green',
  },
};
